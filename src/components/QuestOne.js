                        ...
                        <Row>
                            <Col md="6">
                                <div className="about-content">
                                    <h4 className="about-title">Questence learning tools allow you to create and manage your entire 
                            ...
                            <Col md="6">
                                <div className="about-image">
                                    <img src={process.env.PUBLIC_URL + `/assets/images/sample.png`} className="main-img1" alt="" />
                                    <img src={process.env.PUBLIC_URL + `/assets/images/questone.jpg`} className="main-img2" alt="" />
