    ...
    <>
      <footer className="d-none d-md-flex row row-cols-5 py-5 ">
        ...
        <div className="col-md">
          <p>
            Build skills with courses, certificates, and programmes online from
            world-class trainers and institutions.
          </p>
          <div className="row">
        ...
        <div className="col">
          ...
          <ul className="nav flex-column">
            ...
            <li className="nav-item mb-2">
              <Link to="/courses" className="nav-link p-0 text-white">
                Courses
              </Link>
            </li>
          </ul>
