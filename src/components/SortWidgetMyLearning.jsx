        ...
        <div className="col-sm-12 col-md-4">
          <div className="input-group mb-3">
            ...
            >
              ...
              <option value="name" data-link={`/mylearning?method=name&search=${searchVal}&filter=course&search_menu=naming_convention`} >Name</option>
              <option value="pace" data-link={`/mylearning?method=pace&search=${searchVal}&filter=course&search_menu=self`} >Self Paced</option>
              <option value="fee" data-link={`/mylearning?method=fee&search=${searchVal}&filter=course&search_menu=free_course_offering`} >Free</option>
              <option value="fee" data-link={`/mylearning?method=fee&search=${searchVal}&filter=course&search_menu=payment_required`} >Paid</option>
