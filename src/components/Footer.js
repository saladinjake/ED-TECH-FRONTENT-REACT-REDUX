...
const Footer = () => {
  ...
  return (
    <footer className="footer " style={{}}>
      ...
      <div
        className="footer__item footer__item-full space "
      ...
      >
        ...
        <div className="d-col">
          ...
          <ul className="d-col">
           ...
           <li style={{fontFamily:"Open Sans"}}>
              <Link to={process.env.PUBLIC_URL+ "/help-center"}  >Help Center</Link>
            </li>

            <li style={{ fontFamily: "Open Sans" }}>
              <Link to={process.env.PUBLIC_URL + "/news"}>News & Events</Link>
            </li>*/}
          </ul>
        </div>
        ...
        <div className="d-col">
          ...
          <ul className="d-col">
            <li style={{ fontFamily: "Open Sans" }}>
              <Link to={process.env.PUBLIC_URL + "/terms#terms-of-use"}>
                Terms of Service
              </Link>
            </li>
            <li style={{ fontFamily: "Open Sans" }}>
              <Link to={process.env.PUBLIC_URL + "/honor#honour-code"}>
                Honor Code
              </Link>
            </li>
            <li style={{ fontFamily: "Open Sans" }}>
              <Link to={process.env.PUBLIC_URL + "/privacy#privacy-policy"}>
                Privacy Policy
              </Link>
            </li>
      ...
      <div className="footer__item d-col">
        ...
        <ul className="d-col">
          <li style={{fontFamily:"Open Sans"}}>
            <Link to={process.env.PUBLIC_URL+"/terms#privacy-policy"}>Privacy Policy</Link>
          </li>
          <li style={{fontFamily:"Open Sans"}}>
