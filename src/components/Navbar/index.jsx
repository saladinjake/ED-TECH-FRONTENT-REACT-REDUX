  ...
  return (
    <Fragment>
      ...
      user_roles[0].name === "Instructor" ? (
        ...
        <Fragment>
          <nav className="desktop  main-nav" style={{ position: "fixed", zIndex:"999999999999999999999999" }}>
            ...
            <ul className="mainNav makeText" ref={mobileNav} style={{marginTop:"10px", fontFamily:"Open Sans"}}>
              <li className="NavHover">
                ...
                <ul className="ParentDropDown makeText" style={{fontFamily:"Open Sans"}}>
                          ...
                          return (
                            ...
                            <li onClick={()=>{
                              ...
                              {item.subcategories.length > 0 && item.subcategories.map( (cat,i) =>{
                                              ...
                                              // if(i%2 ===0){
                                                 leftSide+= `<a style="background:#fafafa,font-size: 12px; font-family:'Open Sans'" href="#" >${cat.name}</a>
                                                              `
                                              // }else if(i%2 !==0){
                  ...
                  <li className="ParentDropDown__item" style={{fontFamily:"Open Sans",height:"35px"}}>
                    <span style={{ fontSize: "12px", fontFamily: "Open Sans" }}>  By Program<i className="fa fa-caret-right" style={{float:"right",marginTop:"5px"}}></i></span>
              ...
              <li className="NavHover">
                ...
                <ul className="ParentDropDown makeText">
                  ...
                  <li className="ParentDropDown__item" style={{ fontSize: "16px",fontFamily:"Open Sans" }}>
                    <Link
                      style={{ fontSize: "12px" }}
                      className="DropDown__link"
              ...
              <li className="search__group" style={{ fontSize: "16px",fontFamily:"Open Sans" }}>
                <div className="search__form">
                  ...
                  href="#"
                    ...
                    type="button"
                    style={{color:"#fff", fontSize: "16px",background:"rgb(2, 83, 200)",padding:"10px" }}
                    id="search-btn"
                  >
                    <b style={{textTransform: "capitalize"}}>Search</b>
                    <svg
                      width="14"
                      height="14"
                      viewBox="0 0 14 14"
                  ...
                  href="#"
                    onClick={handleReset}
                    type="button"
                    style={{color:"#fff", display:"none", fontSize: "16px",background:"rgb(2, 83, 200)",padding:"10px" }}
                    id="reset-btn"
                  >
                    <b style={{textTransform: "capitalize",marginRight:"5px"}}>Reset</b>
              ...
              {!isAuthenticated ? (
                <Fragment>
                  ...
                  Log In
                    ...
                    <a
                      style={{ fontSize: "16px",background:"#fff",color:"#000",borderRadius:"43px" }}
                      // onClick={(e) => {
                      //   e.preventDefault();
                  ...
                  <li className="cd-signup" style={{ fontSize: "16px",fontFamily:"Open Sans" }} >
                    <a
                      style={{
                        borderRadius: "43px",
                        fontSize: "16px",
