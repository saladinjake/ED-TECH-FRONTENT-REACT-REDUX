                      ...
                      return (
                          ...
                          >
                                          ...
                                          {item.subcategories.length > 0  && item.subcategories.map( cat =>{
                                            ...
                                            <li class="go-back-menu"><a href="#">
                                               <i class="fas fa-angle-left"></i>Menu</a>
                                            </li>
                                            <li class="go-back">
                                              <a href="#">
                                                ...
                                                <span class="icon">
                                                    ...
                                                    <li><Link onClick={() =>{window.location.href= `${process.env.PUBLIC_URL}/courses/${cat.id}`}} to={`${process.env.PUBLIC_URL}/courses/${cat.id}`}>  {cat.name}</Link></li>
                                      ...
                                      <Link to={ process.env.PUBLIC_URL + "/courses" } class="py-3">
                      ...
                      {isAuthenticated ? (   <div class="wishlist-box menu-icon-box" id="wishlist_items">
                              ...
                              <div class="item clearfix">
                                  <div class="item-image">
                                      <a href="">
                                          <img src="#uploads/thumbnails/course_thumbnails/course_thumbnail_default_26.jpg" alt="" class="img-fluid" />
                                      </a>
                                  </div>
