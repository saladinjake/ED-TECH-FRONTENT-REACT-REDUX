...
import { uuid } from "../../api/enrollment_services/dashboard.services";
      ...
      <div className="topbar-left">
        <div className="text-center">
          ...
          <a alt="noimage" href="index.html" className="logo">
            ...
            <span>
              <img alt="noimage" src="{questence}" height="20" />
            </span>
          </a>
      ...
      <div className="navbar navbar-default" role="navigation">
        <div className="container">
          <div className="" style={{ marginLeft: "-990px" }}>
            <form
              role="search"
              className="navbar-left app-search pull-left hidden-xs"
            >
              <input
                type="text"
                name="search"
              ...
              />
              <a alt="noimage" href="#" onClick={handleSearch}>
            ...
            <ul
              ...
              style={{ marginTop: "-7px", marginRight: "-990px" }}
              ref={mobileNav}
            >
              <li>
                {" "}
                ...
                <Fragment>
                  <li className="hidden-xs">
                    <a
                      alt="noimage"
                      href="#"
                      className="right-bar-toggle waves-effect waves-light"
                  ...
                  >
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li>
                        ...
                        <Link
                          to="#"
                          className="ti-power-off m-r-10 text-danger"
                  ...
                  >
                    ...
                    <ul className="dropdown-menu dropdown-menu-lg">
                      <li className="notifi-title">
                        <span className="label label-default pull-right"></span>
                        My Cart {cart !== undefined && `(${cart?.length})`}
                      </li>
                      <div
                      ...
                      >
                        <li
                          className="list-group slimscroll-noti notification-list"
                          style={{
                            overflow: "hidden",
                            width: "auto",
                            height: "230px",
                                  ...
                                  <div className="media">
                                    ...
                                    <div className="media-body">
                                      <h5 className="media-heading">
                                        A new order has been placed A new order
                                        has been placed
                                      </h5>
                                      <p className="m-0">
                                        <small>
                        ...
                        ></div>
                        <div className="slimScrollRail scrollInsector"></div>
                      </div>
                      <li>
                        <a
                          alt="noimage"
