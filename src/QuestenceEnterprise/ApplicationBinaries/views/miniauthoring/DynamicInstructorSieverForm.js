    ...
    if (event.key == "Enter") {
      ...
      if (
        ...
        if (this.props.sizeOfArray === "1") {
          ...
          let res = this.props.handleAction(
            [...this.state.myItems],
            "unlimited"
          );
    ...
    return (
      <div className="dynamic_input">
        ...
        <p style={{ background: "#f5f5f5", margin: "10px", padding: "4px" }}>
          Note**: Search for an instructor by email to make the lead instructor
          of this course
          <br />
          <span>(Press enter after entering the instructors email</span>
        </p>
        <input
          id="add"
          type="text"
