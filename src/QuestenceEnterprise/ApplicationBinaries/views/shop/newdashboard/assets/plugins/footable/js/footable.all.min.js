...
(function (e, t, undefined) {
  function a(t) {
    ...
    return (
      e.isPlainObject(t.data) && a.data(t.data),
  ...
  function o(t, o) {
    ...
    for (var n = e("<tr>").appendTo(i), r = 0, l = o.cols.length; l > r; r++)
      n.append(a(o.cols[r]));
  }
  function i(t) {
    var a = t.find("tbody");
  ...
  function n(t, a, o) {
    if (o) {
      ...
      var i = t.find("tfoot");
      0 === i.size() &&
        (i = e('<tfoot class="hide-if-no-paging"></tfoot>').appendTo(t)),
  ...
  function s() {
    ...
    (a.name = "Footable Grid"),
            ...
            u
              ...
              .on({
                "footable_initialized.grid": function () {
                  f.url || f.ajax
                    ? e.ajax(f.ajax || { url: f.url }).then(
                        function (e) {
                          a.newItem(e), t.raise(f.events.loaded);
                        },
                        function () {
                          throw (
                            "load data from " + (f.url || f.ajax.url) + " fail"
                          );
                        }
                      )
                ...
                "footable_sorted.grid footable_grid_created.grid footable_grid_removed.grid": function () {
                  f.showIndex &&
                    a.getItem().length > 0 &&
                    u.find("tbody tr:not(." + s + ")").each(function (t) {
              ...
              .on("click.grid", "thead input:checkbox.checkAll", function (e) {
                var t = !!e.currentTarget.checked;
                t
                  ? u.find("tbody tr").addClass(f.activeClass)
      ...
      (a._makeRow = function (o, i) {
        var n,
          r = a.footable.options.grid;
        if (e.isFunction(r.template))
          n = e(r.template(e.extend({}, { __index: i }, o)));
        else {
          n = e("<tr>");
      ...
      (a.newItem = function (t, o, i) {
        ...
        if (e.isPlainObject(t)) {
          var s,
            f = a._items.length;
          if (o === undefined || 0 > o || o > f)
            (s = a._makeRow(t, f++)), a._items.push(t), n.append(s);
          else {
            if (((s = a._makeRow(t, o)), 0 === o))
              a._items.unshift(t), n.prepend(s);
            else {
      ...
      (a.removeItem = function (t) {
        ...
        if (e.isArray(t)) {
          ...
          return (
            a.footable.raise(a.footable.options.grid.events.removed, {
              item: n,
              index: t,
            }),
            n
  ...
  if (t.footable === undefined || null === t.foobox)
    throw Error(
  ...
  var f = {
    grid: {
      ...
      checkboxFormatter: function (e) {
        return (
          '<input type="checkbox" class="' + (e ? "checkAll" : "check") + '">'
        );
      },
      events: {
    ...
    (e.name = "Footable Filter"),
                ...
                "footable_initialized.filtering": function () {
                  var i = t(a.table),
                    o = {
                      ...
                      timeout:
                        i.data("filter-timeout") || a.options.filter.timeout,
                      minimum:
                        i.data("filter-minimum") || a.options.filter.minimum,
                      disableEnter:
                        i.data("filter-disable-enter") ||
                        a.options.filter.disableEnter,
                    };
                  o.disableEnter &&
                    t(o.input).keypress(function (t) {
                      return window.event
        ...
        if (!((l && l.result === !1) || (l.filter && n > l.filter.length)))
          if (l.clear) e.clearFilter();
            ...
            t.each(d, function (t, e) {
              e &&
                e.length > 0 &&
                (o.data("current-filter", e),
                (s = s.filter(i.options.filter.filterFunction)));
            }),
              s.each(function () {
                e.showRow(this, i), t(this).removeClass("footable-filtered");
              }),
              o.data("filter-string", l.filter),
              i.raise("footable_filtered", { filter: l.filter, clear: !1 });
          }
      }),
      ...
      (e.showRow = function (e, a) {
        var i = t(e),
          ...
          n = t(a.table);
        i.is(":visible") ||
          (n.hasClass("breakpoint") &&
          i.hasClass("footable-detail-show") &&
          o.hasClass("footable-row-detail")
            ? (i.add(o).show(), a.createOrUpdateDetailRow(e))
            : i.show());
      });
  }
  ...
  function a(t) {
    ...
    (this.pageNavigation = i.pageNavigation || t.options.pageNavigation),
      ...
      (this.limitNavigation = parseInt(
        i.limitNavigation || t.options.limitNavigation || o.limitNavigation,
        10
      )),
      (this.limitPreviousText =
        i.limitPreviousText || t.options.limitPreviousText),
    ...
    (t.name = "Footable Paginate"),
      ...
      (t.createPages = function (t, a) {
        ...
        d.each(function (e, t) {
          r.push(t),
            e === n - 1
              ? (o.pages.push(r), i++, (n = i * o.pageSize), (r = []))
              : e >= d.length - (d.length % o.pageSize) && l.push(t);
        }),
          ...
          1 === o.pages.length
            ? e(t.table).addClass("no-paging")
            : e(t.table).removeClass("no-paging");
      }),
      (t.createNavigation = function (a) {
        var i = e(a.table).find(a.pageInfo.pageNavigation);
        if (0 === i.length) {
          if (
            ((i = e(a.pageInfo.pageNavigation)),
            i.parents("table:first").length > 0 &&
              i.parents("table:first") !== e(a.table))
          )
            return;
          i.length > 1 &&
            a.options.debug === !0 &&
        ...
        if (0 !== i.length) {
          i.is("ul") ||
            (0 === i.find("ul:first").length && i.append("<ul />"),
            (i = i.find("ul"))),
            i.find("li").remove();
          var o = a.pageInfo;
          (o.control = i),
            ...
            i
              ...
              .on("click", "a[data-page]", function (n) {
                n.preventDefault();
      ...
      (t.createLimited = function (e, t, a) {
        ...
        var i,
          ...
          r = e
            ...
            .parent();
        for (i = t.pages.length - 1; i >= 0; i--)
          (o = t.pages[i]),
            i >= a &&
              a + t.limitNavigation > i &&
              o.length > 0 &&
              n.after(
                '<li class="footable-page"><a data-page="' +
                  i +
      ...
      (t.setPagingClasses = function (e, t, a) {
        e
          .find("li.footable-page > a[data-page=" + t + "]")
          .parent()
          .addClass("active"),
          t >= a - 1 &&
            (e
      ...
      (t.showRow = function (t, a) {
        ...
        i.hasClass("footable-detail-show") &&
        o.hasClass("footable-row-detail")
          ? (i.add(o).show(), a.createOrUpdateDetailRow(t))
          : i.show();
      });
  }
            ...
            t(a.table)
              ...
              .bind({
                    ...
                    n
                      ...
                      .each(function () {
                        var e = t(this),
                          i = a.columns[e.index()];
                        i.sort.ignore === !0 ||
                          e.hasClass(r.sortable) ||
                          (e.addClass(r.sortable),
                          t("<span />").addClass(r.indicator).appendTo(e));
                      }),
                      n
                        .find(
                ...
                "footable_redrawn.sorting": function () {
                  ...
                  i.data("sorted") >= 0 &&
                    i.find("> thead > tr:last-child > th").each(function (a) {
                      var i = t(this);
                      return i.hasClass(o.sorted) || i.hasClass(o.descending)
                        ? (e.doSort(a), undefined)
                        : undefined;
                    });
                },
      ...
      (e.doSort = function (a, i) {
        ...
        if (t(o.table).data("sort") !== !1) {
          ...
          (u && u.result === !1) ||
            ...
            i === undefined && (i = s.hasClass(d.sorted)),
            i
              ? s.removeClass(d.descending).addClass(d.sorted)
              : s.removeClass(d.sorted).addClass(d.descending),
            e.sort(o, r, l, i),
            o.bindToggleSelectors(),
            o.raise(f.sorted, { column: l, direction: i ? "ASC" : "DESC" }));
        }
      }),
        ...
        return (
          a
            ...
            .each(function () {
              ...
              return (
                i !== undefined &&
                  (r.value = e.parse(this.cells[i.sort.match], i)),
                o.push(r),
                !0
              );
            })
        ...
        t(e.table)
          ...
          .each(function () {
            ...
            i
              ...
              0 === a % 2
                ? i.addClass(e.options.classes.striping.even)
                : i.addClass(e.options.classes.striping.odd),
              a++;
          });
      });
  }
  if (e.footable === undefined || null === e.foobox)
    throw Error(
      "Please check and make sure footable.js is included in the page and is loaded prior to this script."
    );
  var i = {
    striping: { enabled: !0 },
    classes: { striping: { odd: "footable-odd", even: "footable-even" } },
  };
  e.footable.plugins.register(a, i);
})(jQuery, window);
(function (t, e, undefined) {
    ...
    if (
      ("footable_row_expanded" == a.type &&
        ...
        u &&
          ...
          p && (c = p.split(",")),
          c.push(u.rowIndex),
          t(e.table).data("expanded_rows", c.join(",")))),
      "footable_row_collapsed" == a.type && (u = a.row))
    ) {
          ...
          t(e.table).bind({
            footable_initialized: function () {
              ...
              if (o) {
                ...
                t(d).val(o),
                  t(e.table).trigger("footable_filter", { filter: o });
              }
            ...
            "footable_page_filled footable_redrawn footable_filtered footable_sorted footable_row_expanded footable_row_collapsed": function (
              a
            ) {
              if ((i(e, a), e.lucid_bookmark_read)) {
                ...
                for (var h in g)
                  g[h] !== undefined &&
                    b.push(h + "=" + encodeURIComponent(g[h]));
