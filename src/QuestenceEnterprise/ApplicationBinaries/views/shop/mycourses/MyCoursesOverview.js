  ...
  render() {
    return (
      <Fragment>
        ...
        <link
          rel="stylesheet"
          href="https://unpkg.com/isotope/dist/isotope.min.css"
        />
        <div className="content-page">
          ...
          <footer className="footer">© 2016. All rights reserved.</footer>
        </div>
        <Sidebar />
      </Fragment>
    );
