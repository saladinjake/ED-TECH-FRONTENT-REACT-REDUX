                  ...
                  <div className="container">
                    ...
                    <div className="row">
                      <div className="col-xs-12">
                        <div
                          className="card-box product-detail-box"
                          style={{ background: "#ebeff2" }}
                        >
                          <div className="row">
                            <div
                              className="col-sm-4 card-box"
                              style={{ background: "#fafafa" }}
                            >
                              <div className="sp-wrap">
                                <img
                                  className="img-responsive card-box"
                                  src={`${
                            ...
                            <div className="col-sm-8 card-box">
                              <div className="product-right-info">
                                <h3>
                                  <b> {coursedetails?.data?.course_name}</b>
                                </h3>
                                <div className="rating">
                                  <ul className="list-inline">
                                    <li>
                                ...
                                <h2>
                                  {" "}
                                  <b>NGN{coursedetails?.data?.price}</b>
                                  <small className="text-muted m-l-10">
                                    <del>NGN30,000</del>{" "}
                                  </small>
                                </h2>

                                <h5 className="m-t-20">
                                  <b>Students Registered: </b> 2500 canditates .{" "}
                                  <span className="label label-default m-l-5">
                                    in counting
                                  </span>
                                </h5>
