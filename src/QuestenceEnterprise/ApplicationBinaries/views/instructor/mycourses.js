...
import { addToWishlist } from "../../api/enrollment_services/wishlist.services";
  ...
  return (
    <div className="carousel-containerx ">
      ...
      <div className="carousel-wrapperx container-fluid">
        ...
        <div
          className="carousel-content-wrapperx gridDisplay shown"
        ...
        {children.map((item, i) => {
          return (
            <div
              key={"ramlink" + item?.id}
              className="card-box bookset product-view col-merge-12 col-merge-s-4 col-merge-d3"
              style={{ marginRight: "3px", height: "310px" }}
            >
              <figure
                style={{
