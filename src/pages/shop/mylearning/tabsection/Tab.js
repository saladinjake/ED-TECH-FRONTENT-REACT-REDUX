...
const MyLearningContainer = (props) => {
  ...
  return (
    <div
      ...
      style={{ height: "1700px", overflow: "scroll" }}
    >
      <br />
      <br />
      <br />
          ...
          <div className="mylearning-title">
            ...
            <div class="btn-group pull-right m-t-15 open">
              ...
              <ul class="dropdown-menu drop-menu-right" role="menu">
                ...
                <li>
                  <a href="/notifications">Account Settings</a>
                </li>
                <li>
                  <a href="/cart">Cart</a>
                </li>
      ...
      <div className="row">
        ...
        <div className="col-md-8 col-sm-12 ">
          {toggleGridList ? (
            ...
            <ul className="nav nav-tabs tabs" id="nav-tabs">
              <li
              ...
              <li
                ...
                style={{ width: "25%" }}
                onClick={() => {
                  filterSelection("Acomplishments");
                }}
              >
                  ...
                  {courses.map((course, i) => {
                    ...
                    return (
                      <tr
                        ...
                        key={i}
                        className={status_state + " requestedFilter"}
                      >
                        <td
                          style={{
                            backgroundColor: "#fff",
                        ...
                        <td style={{ backgroundColor: "#fff", width: "300px" }}>
                          <Link to="/">
                            <strong>{course.course_name}</strong>
                          </Link>
                        </td>
                        <td style={{ backgroundColor: "#fff", width: "100px" }}>
                          {"fill this field"}
                        </td>

                        <td style={{ backgroundColor: "#fff" }}>
                          {dateToYMD(new Date(course.start_date))}
                        </td>
                        <td style={{ backgroundColor: "#fff" }}>
                          {course.learning_style || "Unlimited"}
                        </td>
                        <td style={{ backgroundColor: "#fff" }}>
                          {course.price}
                        </td>
