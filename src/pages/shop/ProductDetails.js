                                    ...
                                    <div className="product-information">
                                        ...
                                        <div className="product-rating d-flex">
                                            ...
                                            <div className="review-num">
                                                <Link to={process.env.PUBLIC_URL + "/"}>( Rating )</Link>
                                            </div>
                                        </div>
                                        ...
                                        <div className="product-stock">
                                            <p>User type : <span className="stock">Learner</span></p>
                                        </div>
                                        ...
                                        <div className="product-cart-wh-com-btn">
                                            <Link to={process.env.PUBLIC_URL + "/product-details"} className="cart-btn">Change picture</Link>
                                        </div>
                                    </div>
                                </Col>
