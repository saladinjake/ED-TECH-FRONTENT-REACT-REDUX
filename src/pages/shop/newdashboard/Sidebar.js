    ...
    <Fragment>
      ...
      >
        <div class="sidebar-inner slimscrollleft">
          <div id="sidebar-menu">
            <ul>
              <li class="menu-title" style={{ color: "#fff" }}>
                <img src={questence} />
              </li>
              ...
              <li class="has_sub" style={{ border: "1px solid #eee" }}>
                <Link
                  ...
                  style={{ color: "#555" }}
                >
                  <i class="fa fa-graduation-cap"></i> <span> All courses</span>{" "}
                  <span class="menu-arrow"></span>
                </Link>
                <ul class="list-unstyled"></ul>
              </li>
              ...
              <li class="has_sub" style={{ border: "1px solid #eee" }}>
                <Link
                  to={`${process.env.PUBLIC_URL + "/mycourses"}`}
                  class="waves-effect"
                  style={{ color: "#555" }}
                >
                  <i class="fa fa-user"></i> <span> My courses </span>{" "}
                  <span class="menu-arrow"></span>
                </Link>
                <ul class="list-unstyled"></ul>
              </li>
              ...
              <li class="has_sub">
                <Link
                  ...
                  style={{ color: "#555" }}
                >
                  <i style={{ color: "lightblue" }} class="fa fa-bell"></i>{" "}
                  <span> Notifications </span> <span class="menu-arrow"></span>
                </Link>
                <ul class="list-unstyled"></ul>
              </li>
              ...
              <li class="has_sub">
                <Link
                  ...
                  style={{ color: "#555" }}
                >
                  <i style={{ color: "#555" }} class="fa fa-user"></i>{" "}
                  <span>Account Profile</span> <span class="menu-arrow"></span>
                </Link>
                <ul class="list-unstyled"></ul>
              </li>
              ...
              <li class="has_sub">
                <Link
                  ...
                  style={{ color: "#555" }}
                >
                  <i style={{ color: "#555" }} class="fa fa-shopping-cart"></i>{" "}
                  <span> Cart</span> <span class="menu-arrow"></span>
                </Link>
                <ul class="list-unstyled"></ul>
              </li>
      ...
      <div
        class="side-bar right-bar nicescroll"
        id="rightSide"
      ...
      >
        <h4 class="text-center">
          <span
            ...
            class="close fa  fa-cancel"
            onClick={(e) => {
              document.getElementById("rightSide").style.right = "-400px";
            }}
          >
            close
          </span>{" "}
        ...
        <div class="contact-list nicescroll" style={{ background: "#ebeff2" }}>
          <ul
            class="list-group contacts-list"
            style={{ background: "#ebeff2" }}
          >
