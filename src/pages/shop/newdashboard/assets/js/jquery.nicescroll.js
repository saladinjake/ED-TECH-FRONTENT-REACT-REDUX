/* jquery.nicescroll 3.5.0 InuYaksa*2013 MIT http://areaaperta.com/nicescroll */ (function (
  e
) {
  var z = !1,
    E = !1,
  ...
  var A = window.MutationObserver || window.WebKitMutationObserver || !1,
    ...
    P = function () {
      ...
      c.transitionend = !1;
      for (
        var k = "transition webkitTransition MozTransition OTransition OTransition msTransition KhtmlTransition".split(
            " "
          ),
    ...
    Q = function (h, c) {
      ...
      function q(d, c, f, g) {
        b._bind(
          ...
          function (b) {
            ...
            "mousewheel" == c
              ? ((g.deltaY = -0.025 * b.wheelDelta),
                b.wheelDeltaX && (g.deltaX = -0.025 * b.wheelDeltaX))
              : (g.deltaY = b.detail);
            return f.call(d, g);
          },
          g
      ...
      function t(d, c, f) {
        var g, e;
        0 == d.deltaMode
          ? ((g = -Math.floor(d.deltaX * (b.opt.mousescrollstep / 54))),
            (e = -Math.floor(d.deltaY * (b.opt.mousescrollstep / 54))))
          : 1 == d.deltaMode &&
            ((g = -Math.floor(d.deltaX * b.opt.mousescrollstep)),
      ...
      this.ishwscroll =
        (this.canhwscroll = g.hastransform && b.opt.hwacceleration) &&
        b.haswrapper;
      ...
      b.opt.enablemouselockapi ||
        ((g.hasmousecapture = !1), (g.haspointerlock = !1));
          ...
          b.railh &&
            ...
            (d = b.railh.align
              ? f +
                ...
                b.win.innerHeight() -
                b.railh.height
              : f + l(b.win, "border-top-width", !0)),
            (g += l(b.win, "border-left-width")),
            b.railh.css({ top: d, left: g, width: b.railh.width }));
        }
      };
      this.doRailClick = function (d, c, f) {
        ...
        b.locked ||
          (b.cancelEvent(d),
          c
            ? ((c = f ? b.doScrollLeft : b.doScrollTop),
              (g = f
                ...
                : (d.pageY - b.rail.offset().top - b.cursorheight / 2) *
                  b.scrollratio.y),
              c(g))
            : ((c = f ? b.doScrollLeftBy : b.doScrollBy),
      ...
      this.init = function () {
        ...
        b.zindex = "auto";
        b.zindex =
          !b.ispage && "auto" == b.opt.zindex ? k() || "auto" : b.opt.zindex;
        ...
        if (!b.ispage || (!g.cantouch && !g.isieold && !g.isie9mobile)) {
          ...
          for (q in x)
            (h = x[q]),
              (l = b.opt.railpadding[h])
                ? f.css("padding-" + h, l + "px")
                : (b.opt.railpadding[h] = 0);
          f.append(c);
          f.width =
          ...
          if (g.isie9mobile)
            (b.scrollmom = new J(b)),
              (b.onmangotouch = function (d) {
                ...
                var f = d - b.mangotouch.sy,
                  g = c - b.mangotouch.sx;
                if (
                  0 != Math.round(Math.sqrt(Math.pow(g, 2) + Math.pow(f, 2)))
                ) {
                  var n = 0 > f ? -1 : 1,
                    e = 0 > g ? -1 : 1,
                    k = +new Date();
                  b.mangotouch.lazy && clearTimeout(b.mangotouch.lazy);
                  80 < k - b.mangotouch.tm ||
                  b.mangotouch.dry != n ||
                  b.mangotouch.drx != e
                    ? (b.scrollmom.stop(),
                ...
                if (!b.locked) {
                  ...
                  if (!g.cantouch && !this.istouchcapable && !g.hasmstouch) {
                    if (!c || !/INPUT|SELECT|TEXTAREA/i.test(c.nodeName))
                      return (
                        !b.ispage && g.hasmousecapture && c.setCapture(),
                        b.opt.touchbehavior
                          ? b.cancelEvent(d)
                          : b.stopPropagation(d)
                      );
            ...
            if (g.cantouch || b.opt.touchbehavior)
              (b.onpreventclick = function (d) {
                ...
                b.opt.grabcursorenabled &&
                  ...
                  b.css(b.rail, { cursor: g.cursorgrabvalue }));
            else {
              var p = function (d) {
                if (b.selectiondrag) {
                  if (d) {
            ...
            !g.cantouch && !b.opt.touchbehavior
              ? (b.bind(
                  g.hasmousecapture ? b.win : document,
                  "mouseup",
                  b.onmouseup
                ),
            ...
            b.opt.enablemousewheel &&
              (b.isiframe ||
                b.bind(
                  g.isie && b.ispage ? document : b.win,
                  "mousewheel",
                  b.onmousewheel
                ),
          ...
          b.onkeypress = function (d) {
            ...
            if (
              ...
              switch (c) {
                ...
                case 63232:
                  b.railh &&
                    (f ? b.doScrollLeft(0) : b.doScrollLeftBy(72), (g = !0));
                  break;
                case 39:
                case 63234:
                  b.railh &&
                    (f ? b.doScrollLeft(b.page.maxw) : b.doScrollLeftBy(-72),
                    (g = !0));
                  break;
                case 33:
                case 63276:
          ...
          b.opt.enablekeyboard &&
            b.bind(
              document,
              g.isopera && !g.isopera12 ? "keypress" : "keydown",
              b.onkeypress
            );
          ...
          !b.ispage &&
            ...
            (!1 !== A
              ...
              : (b.bind(
                  b.win,
                  g.isie && !g.isie9 ? "propertychange" : "DOMAttrModified",
                  b.onAttributeChange
                ),
                g.isie9 &&
        ...
        if ("IFRAME" == this.doc[0].nodeName) {
          var K = function (d) {
            ...
            b.opt.enablekeyboard &&
              b.bind(c, g.isopera ? "keypress" : "keydown", b.onkeypress);
            if (g.cantouch || b.opt.touchbehavior)
              b.bind(c, "mousedown", b.ontouchstart),
                ...
                b.opt.grabcursorenabled &&
                  g.cursorgrabvalue &&
                  b.css(e(c.body), { cursor: g.cursorgrabvalue });
      ...
      this.onResize = function (d, c) {
        ...
        if (b.page.maxh == f && b.page.maxw == g && b.view.w == e) {
          ...
          if (
            b.lastposition &&
            ((g = b.lastposition), g.top == f.top && g.left == f.left)
          )
            return b;
          b.lastposition = f;
        }
      ...
      this.bind = function (d, c, f, e) {
        ...
        "mousewheel" == c
          ? "onwheel" in b.win
            ? b._bind(k, "wheel", f, e || !1)
            : ((d =
                "undefined" != typeof document.onmousewheel
                  ? "mousewheel"
                  : "DOMMouseScroll"),
              q(k, d, f, e || !1),
              "DOMMouseScroll" == d && q(k, "MozMousePixelScroll", f, e || !1))
          : k.addEventListener
          ? (g.cantouch &&
            ...
            g.cantouch &&
              "mouseup" == c &&
              b._bind(k, "touchcancel", f, e || !1))
          : b._bind(k, c, function (d) {
      ...
      this.getViewport = function (b) {
        for (
          ...
          if (
            (/scroll|auto/.test(f) && b.clientHeight != b.scrollHeight) ||
                ...
                0 < l &&
                  ...
                  g.transitionend
                    ? b.scrollendtrapped ||
                      ...
                      b.bind(b.doc, g.transitionend, b.onScrollEnd, !1))
          ...
          : ((this.doScrollLeft = function (c, g) {
            ...
            (this.doScrollPos = function (c, g, f) {
              ...
              b.bzscroll =
                0 < h
                  ? b.bzscroll
                    ? b.bzscroll.update(q, h)
                    : new BezierClass(m, q, h, 0, 1, 0, 1)
                  : !1;
              if (!b.timer) {
                ((k == b.page.maxh && g >= b.page.maxh) ||
      ...
      this.doZoomIn = function (c) {
        if (!b.zoomactive) {
          ...
          ("" == k ||
            /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(k)) &&
    ...
    J = function (e) {
      ...
      this.doSnapy = function (e, l) {
        ...
        0 > l
          ? ((l = 0), (h = !0))
          : l > c.nc.page.maxh && ((l = c.nc.page.maxh), (h = !0));
        0 > e
          ? ((e = 0), (h = !0))
  ...
  e.cssHooks.pageYOffset = {
    get: function (h, c, k) {
      return (c = e.data(h, "__nicescroll") || !1) && c.ishwscroll
        ? c.getScrollTop()
        : B.call(h);
    },
    set: function (h, c) {
  ...
  e.fn.getNiceScroll = function (h) {
    return "undefined" == typeof h
      ? new D(this)
      : (this[h] && e.data(this[h], "__nicescroll")) || !1;
  };
  e.extend(e.expr[":"], {
