...
function FreeCourse() {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    values.previous_institutions = JSON.stringify(
      values.previous_institutions.split(",")
    );
          ...
          <Row>
            ...
            <Col md="6">
              <div
                ...
                style={{
                  backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/instructor-about.png)`,
                }}
              >
