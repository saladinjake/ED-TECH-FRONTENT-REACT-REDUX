...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    password_confirmation: document.getElementById("password_confirmation1").value,
  }
  ...
  return (
    <Styles>
      ...
      <div className="main-wrapper registration-page overlay__modal2" 
      id="register-box"  
      style={{
        marginTop:"20px",
        height:"500px",
       ...
       <a className="overlay__close2 fa fa-close fa-2x" style={{float:"right",color:"darkblue"}}></a>
                   ...
                   <div className="not_account-btn text-center">
                      ...
                      >
                        ...
                        <p className="form-control form-group">
                          ...
                          <a style={{display:"block"}} href="#pass"  onClick={(e)=>{myFunction(e)}} >Show Password</a>
                        ...
                        <button type="submit" className="btn btn-primary" href="#" onClick={(e)=>{
                          // e.preventDefault()
                          // handleSubmit(e)
                        }}>
                          {loading ? (
