  ...
  return (
    ...
    {editClicked == true ? (
      ...
      {loading ? (
        ...
        <section className="course-header-area" style={{ marginTop: "-70px" }}>
                ...
                <Row>
                                  ...
                                  <header >
                                    <div class="container card-box" >
                                      <div class="profile-sect " >
                                        ...
                                        <div class="profile-user-settings" style={{marginTop:"-30px",color:"#fff",background:"#0253c8"}}>
                                          <h1  style={{color:"#fff",background:"#0253c8",marginLeft:"10px"}}>
                                            {
                                              coursedetails?.data?.instructor
                                                ?.first_name
                                            }{" "}
                                          ...
                                          <div class="profile-bio-sect" style={{color:"#fff",background:"#0253c8",padding:"5px"}}>
                                            <h6 style={{color:"#fff",background:"#0253c8",marginLeft:"10px"}}>
                                              {
                                                coursedetails?.data?.instructor
                                                  ?.instructor_profile
                                                  ?.brief_introduction
                                            ...
                                            <p style={{color:"#fff",background:"#0253c8",marginLeft:"10px"}}>
                                        ...
                                        <hr style={{background:"#000",border:"1px solid #fee"}}/>
                                            ...
                                            <header style={{}}>
                                              <div class="container card-box">
                                                <div class="profile-sect " >
                                                  ...
                                                  <div class="profile-user-settings" style={{background:"#0253c8", marginTop:"-40px"}}>
                                                    ...
                                                    <hr/>
                                                    <div class="profile-bio-sect" style={{background:"#0253c8",color:"#fff",padding:"5px"}}>
                                                      <h6 style={{color:"#fff",background:"#0253c8", marginLeft:"10px"}}>
                                                        {
                                                          collaborators
                                                            ?.instructor_profile
                  ...
                  <Col lg="4" md="4" sm="12">
                    <div
                      ...
                      style={{ marginTop: "-280px",zIndex:"9999999999999999999999999999999",opacity:"1" }}
                    >
                      <Row>
                        <Col md="12">
                          <div className="course-details-feature" style={{zIndex:"9999999999999999999999999999999",opacity:"1" }}>
                            <div
                            ...
                            <div style={{ marginTop: "-70px" }}>
                              <ul className="list-unstyled feature-list-maker">
                               ...
                               {parseInt(user.id) === parseInt(coursedetails?.data?.instructor?.id) && token && isAuthenticated && user_roles[0].name === "Instructor" &&
