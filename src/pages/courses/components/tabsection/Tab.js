 ...
 let allcoursesFetched = [],
  ...
  const isDistantFuture = (date, seconds = 0) => {
    ...
    completedcourses = mycourse.filter(course =>{
     ...
     allcoursesFetched = allcoursesFetched.filter((v,i,a)=>a.findIndex(t=>(t.course.course_name === v.course.course_name && t.course.course_id===v.course.course_id))===i)
                          ...
                          <tbody>
                              {allcoursesFetched.map((course, i)=>{
                                ...
                                return (
                                  ...
                                  <td><Link to=''><strong>{course.course.course_name}</strong></Link></td>
                                  <td></td>
                                  <td>{course?.course?.price}</td>
                                  <td>{dateStarted.toLocaleDateString("en-US")}</td>
                                  <td>{dateEnd.toLocaleDateString("en-US")}</td>
                                 
                                 
                                  
                                  <td><div className={"alert "+ activity  }>{ course.set_status}</div></td>
                                  </tr> 
                ...
                <div className="toggleBtn">
                 ...
                 <table className="table table-borderless responsive">
                         <thead>
                          ...
                          <tbody>
                              {activecoursesFetched.length>0 &&  activecoursesFetched.map((course, i)=>{
                               var dateStarted  = new Date(course.start_date);
                                var dateEnd = new Date(course.end_date);
                   ...
                   <MyCourses courses={upcomingcourses}/> :
                    ...
                    <table className="table table-borderless responsive">
                         <thead>
                          ...
                          <tbody>
                              {upcomingcourses.length > 0 &&  upcomingcourses.map((course, i)=>{
                                var dateStarted  = new Date(course.start_date);
                                var dateEnd = new Date(course.end_date);
                                ...
                                return (
                                  ...
                                  <td><div className={"alert alert-warning"  }>Upcoming</div></td>
                                  </tr> 
                ...
                <Tab eventKey="completedcourses" title="Completed Courses">
                   ...
                   <MyCourses courses={completedcourses} /> :
                    ...
                    <table className="table table-borderless ">
                          ...
                          <tbody>
                              {completedcourses.length> 0  && completedcourses.map((course, i)=>{
                                 var dateStarted  = new Date(course.start_date);
                                var dateEnd = new Date(course.end_date);
                                ...
                                return (
                                  ...
                                  <td><Link to=''><strong>{course.course_name}</strong></Link></td>
                                  <td>{course?.instructor?.user?.last_name} {course?.instructor?.user?.first_name}</td>
                                  <td>{course.price}</td>
                                  <td>{dateStarted.toLocaleDateString("en-US")}</td>
                                  <td>{dateEnd.toLocaleDateString("en-US")}</td>
                                  <td>
                                  ...
                                  <td><div className={"alert alert-danger"  }>{ status_state}</div></td>
                                  </tr> 
                 ...
                 <table className="table table-borderless ">
                       <thead>
                          ...
                          <tbody>
                              {wishlistcourses.length> 0 && wishlistcourses.map((course, i)=>{
                                var dateStarted  = new Date(course.start_date);
                                var dateEnd = new Date(course.end_date);
                                ...
                                return (
                                  ...
                                  <td><div className={"alert "+ activity  }>{ status_state}</div></td>
                                  </tr> 
                   ...
                   <MyCourses courses={accomplishedcourses} /> :
                    ...
                    <table className="table table-borderless ">
                          ...
                          <tbody>
                              {accomplishedcourses.length> 0  && accomplishedcourses.map((course, i)=>{
                                var dateStarted  = new Date(course.start_date);
                                var dateEnd = new Date(course.end_date);
