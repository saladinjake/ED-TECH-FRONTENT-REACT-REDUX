...
class FileUploadComponent extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      topics:
        "[{'title' => 'Module 1 - Excuses', 'parent_id' => '1'}, {'title' => '<p>Module 1 - Life</p>', 'parent_id' => '2'}, {'title' => '<h1>Module 1 - Path</h1>', 'parent_id' => '3'}]",
        ...
        >
          {languageList.length > 0 &&
            languageList.map((language) => {
              return <option value={language.id}>{language}</option>;
            })}
        </select>
