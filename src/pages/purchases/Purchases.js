...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-12 ">
      <h3 >Payments And Purchase History</h3><br/>
      ...
      <div class="card">
        ...
        <div >
          ...
          <div className="tab-content">
            <div className="tab-pane active tabcontent" id="form-reset" role="tabpanel">
               <Container>
            <Row>
              <Col md="12">
              <h5>Payment Cards</h5><br/>

                 <p> 
                All payment cards used during purchase would be added here
               </p><br/>
  ...
  <div className="md-modal md-effect-12" id="md-modal" style={{margin:"auto"}}>
    <div className="md-content"><br/>
        <h3>Add A New Card</h3><br/><br/>
        <div>
            <p className="text-muted">Show the card form</p>
            <br/><br/>
            <ul>
                <li><strong>And a button to create card</strong> would be revoked</li>
