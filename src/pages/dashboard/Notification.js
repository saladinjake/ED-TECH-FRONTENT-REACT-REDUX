                            ...
                            <div className="card-box">
                                ...
                                <div className="widget-chart text-center" style={{marginLeft:"50px"}}>
                                      ...
                                      <div >
                                        ...
                                        { Number(profile.completeness) !== 100 ? <a href={process.env.PUBLIC_URL+ "/learner/profile"}  className="text-dark m-t-0 m-b-30" style={{marginTop:"14px", marginRight:"7px"}}> complete your profile<span className="fa fa-arrow-right"> </span></a> :<a href={process.env.PUBLIC_URL+ "/learner/profile"}   className="text-dark m-t-0 m-b-30" style={{marginTop:"14px", marginRight:"7px"}}> Edit your profile<span className="fa fa-arrow-right"> </span></a> }
                                    </div><svg className="hidden">
                                        <circle id="percent-circle-svg" cx="50%" cy="50%" r="50%" stroke-alignment="inner"></circle>
                                    </svg>
