            ...
            <div className="carousel-wrapper">
              ...
              <div className="product-list-box thumb">
                    <Link to={ '../courses/'+ item.id +'/'+ item.slug} className="image-popup" title="Screenshot-1">
                       {item.course_cover_image !==null ? (<img src={item.course_cover_image} className="thumb-img " alt="work-thumbnail" style={{width: "100%",
  height: "auto"}} />
                    ) : (<Fragment />)}   </Link>
                    ...
                    <div className="detail" key={i}>
                                 <div className="rating" style={{width:"100px"}}>
                                                <ul className="list-inline">
                                                    <li><span alt="hello-1" className="fa fa-star" href="#"></span></li>
                                                    <li><span alt="hello-2" className="fa fa-star" href="#"></span></li>
                                            ...
                                            <h5 className="m-0"> <span className="text-muted"> {item.instructor.user.username !==null  && "Instructor" + item.instructor.user.username}</span></h5>
                        </div>
              </div>
      </div>)     
                                   })}
