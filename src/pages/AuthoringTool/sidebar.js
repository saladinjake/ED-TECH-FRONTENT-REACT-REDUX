          ...
          <div className="card">
            <div className="card-body">
              <h4 className="header-title mb-3">
                ...
                >
                  {" "}
                  <i className=" mdi mdi-keyboard-backspace"></i> Back to course
                  list
                </a>
              </h4>
            ...
            <div className="card-body">
              ...
              <div className="mt-3 chartjs-chart" style={{ height: "320px" }}>
                ...
                <canvas
                  id="task-area-chart"
                  width="546"
                  style={{ display: "block", height: "320px", width: "182px" }}
                ...
                <div className="col-sm-6 col-md-3">
                  <a href="/user/payout_report" className="text-secondary">
                    <div className="card shadow-none m-0 border-left">
                      <div className="card-body text-center">
                        <i
                          className="fa fa-mail text-muted"
                          style={{ fontSize: "24px" }}
                        ></i>
                        <h3>
                          <span>₦0</span>
                ...
                <div className="col-sm-6 col-md-3">
                  <a href="/user/payout_report" className="text-secondary">
                    <div className="card shadow-none m-0 border-left">
                      <div className="card-body text-center">
                        <i
                          className="fa fa-pin text-muted"
                          style={{ fontSize: "24px" }}
                        ></i>
                        <h3>
                          <span>₦0</span>
            ...
            <div className="card-body">
              ...
              <div className="my-4 chartjs-chart" style={{ height: "202px" }}>
                ...
                <canvas
                  ...
                  width="546"
                  style={{ display: "block", height: "202px", width: "182px" }}
                  className="chartjs-render-monitor"
                  height="606"
                ></canvas>
              </div>
              ...
              <div className="col">
                <a href="#" className="text-secondary">
                  ...
                  >
                    <div className="card-body text-center">
                      <i
                        className="fa fa-bookmark text-muted"
                        style={{ fontSize: "24px" }}
                      ></i>
                      <h3>
                        <span>0 </span>
              ...
              <div className="col">
                <a href="#" className="text-secondary">
                  ...
                  >
                    <div className="card-body text-center">
                      <i
                        className="fa fa-tags text-muted"
                        style={{ fontSize: "24px" }}
                      ></i>
                      <h3>
                        <span>0</span>
      ...
      <div className="col-md-12">
        <div className="card">
          ...
          {/* <div class="table-responsive-sm mt-4">
                ...
                <div id="course-datatable-server-side_processing" class="dataTables_processing card" >Processing...</div></div></div><div class="row"><div class="col-sm-12 col-md-5"><div class="dataTables_info" id="course-datatable-server-side_info" role="status" aria-live="polite">Showing 1 to 2 of 2 entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="course-datatable-server-side_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="course-datatable-server-side_previous"><a href="#" aria-controls="course-datatable-server-side" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li><li class="paginate_button page-item active"><a href="#" aria-controls="course-datatable-server-side" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item next disabled" id="course-datatable-server-side_next"><a href="#" aria-controls="course-datatable-server-side" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li></ul>
      ...
      >
        ...
        <ul className="metismenu side-nav side-nav-light">
          ...
          <li className="side-nav-item">
            <a
              href={process.env.PUBLIC_URL + "/authoring/dashboard"}
          ...
          <li className="side-nav-item">
            <a
              href={process.env.PUBLIC_URL + "/authoring/sales/history"}
              className="side-nav-link "
            >
          ...
          <li className="side-nav-item">
            <a
              href={process.env.PUBLIC_URL + "/authoring/payment/history"}
              className="side-nav-link "
            >
          ...
          <li className="side-nav-item">
            <a
              href={process.env.PUBLIC_URL + "/authoring/payment/settings"}
              className="side-nav-link "
            >
          ...
          <li className="side-nav-item">
            <a
              href={process.env.PUBLIC_URL + "/authoring/profile/settings"}
              className="side-nav-link"
            >
