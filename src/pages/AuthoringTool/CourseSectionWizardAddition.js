...
const createLessonSection =(el) =>{
  let panel_id = localStorage.getItem("s_tracker")
  let panel_class = $(".muu_" +panel_id )
  let lesson_components = document.getElementById("myModalLessonGroup");
  lesson_components.style.display="block"
  let Clone = lesson_components.cloneNode(true);
  // Clone.querySelector(".closeit").addEventListener("click", (e) => {
  ...
  panel_class.after($(Clone))

  
  //show the modal box content

  //then handle apending of content to the main position where lesson is to be added
...
let call =true
 const  handleClonedEvents = (e) => {
   ...
   if( call== true && e.target.matches(".trigger-lesson-content") && e.target.hasAttribute("data-template") && e.target.hasAttribute("data-type")){
    call = false;
...
const handleWidgetClick = e => {
  ...
  let Target = $(".muu_"+ localStorage.getItem("s_tracker"));
  ...
  Target.after(MainClone);
  // Target.parentElement.appendChild(that.PlaceholderTemplate());
  // Target.remove(Target);

  if(document.querySelector(".closeit")){
    document.querySelector(".closeit").parentElement.parentElement.style.display="none"
  }
...
{/* WIDGET SECTIONS */}
          <div class="pb-widget-preview">
            <div style={{background:"#ebebeb"}}>
                  ...
                  <span class="panel-title" style={{float:"left",color:"#000",marginLeft:"10px"}}>Headings</span>
                            <div class="actions-set"> 
                             <i class="pb-handle-widget fa fa-edit" ></i>
                               ...
                               <i class="pb-remove fa fa-trash" ></i>
                      ...
                      <div class="col-md-10">
                        <div class="panel panel-dark">
                          ...
                          <div class="panel-body">
                            <h4 class="a-text-place-holder1">Adds a dummy information about 
                            the component</h4>
                            <h5 class="a-text-place-holder1">Adds more detail about</h5>
...
{/*lesson categories section goes here*/}
    
    <div id="myModalLessonGroup" class="modal-build">
      <div class="modal-build-inner">
        
        <div class="modal-toolbar" style={{background:"#fff"}}>
          <h2 class="modal-title" style={{display:"none"}}>Select A Lesson Components</h2>
          <i id="pb-modal-close" class="fa fa-times closeit"  style={{color:"rgba(8,23,200)"}}></i>
        </div>


        <div class="modal-tabs" style={{display:"none"}}>
          <div class="modal-tab widgets-tab active-tab">
          <i class="tab-icon fa fa-hammer"></i>Textual Content</div>
        ...
        <div class="modal-build-content widgets-tab active-content container-fluid">
           ...
           <div class="box-inset col-md-3">
                <h1 style={{marginTop:"100px",fontSize:"15px"}}>html</h1>
              <div class="wrapper-box">
                <input  type="checkbox" />
                <div class="fab"></div>
                <div class="fac">
                  <a class="trigger-lesson-content" href="#" data-title="html" data-template="[pb_link][/pb_html]" data-type="content-block" ><i class="fa fa-link"></i>Add  HTML Component</a>
                  <a class="trigger-lesson-content" href="#" data-title="iframe" data-template="[pb_iframe][/pb_iframe]" data-type="content-block"><i class="fa fa-link"></i>Add  IFRAME Component</a>
                                 </div>
              </div>
              </div>
           ...
           <div class="box-inset col-md-3">
                <h1 style={{marginTop:"100px",fontSize:"15px"}}>Problems</h1>
              <div class="wrapper-box">
                <input  type="checkbox" />
                <div class="fab"></div>
                <div class="fac">
                  <a class="trigger-lesson-content" href="#" data-title="html" data-template="[pb_html][/pb_html]" data-type="content-block" ><i class="fa fa-link"></i>Add Common Problems</a>
                  <a class="trigger-lesson-content" href="#" data-title="iframe" data-template="[pb_html][/pb_chkbox]" data-type="content-block"><i class="fa fa-link"></i>Add  Checkboxes</a>
                  <a class="trigger-lesson-content" href="#" data-template="[pb_html][/pb_dropdown]" data-type="content-block">Drop Down</a>
                  <a class="trigger-lesson-content" href="#" data-title="html" data-template="[pb_html][/pb_multichoice]" data-type="content-block" ><i class="fa fa-link"></i>Add Multiple Choice</a>
                  <a class="trigger-lesson-content" href="#" data-title="iframe" data-template="[pb_html][/pb_numeric]" data-type="content-block"><i class="fa fa-link"></i>Add  Numerical Input</a>
                  <a class="trigger-lesson-content" href="#" data-template="[pb_html][/pb_input]" data-type="content-block">Text Input</a>
                
                {/*  <a href="#" data-title="iframe" data-template="[pb_html_hint][/pb_chkbox]" data-type="content-block"><i class="fa fa-link"></i>Checkboxes + hint and feed back</a>
                  <a class="trigger-lesson-content" href="#" data-template="[pb_html_hint][/pb_dropdown]" data-type="content-block">Drop Down + hint and feed back</a>
                  <a class="trigger-lesson-content" href="#" data-title="html" data-template="[pb_html_hint][/pb_multichoice]" data-type="content-block" ><i class="fa fa-link"></i>Multiple Choice + hint and feed back</a>
                  <a class="trigger-lesson-content" href="#" data-title="iframe" data-template="[pb_html_hint][/pb_numeric]" data-type="content-block"><i class="fa fa-link"></i> Numerical Input + hint and feed back</a>
                  <a class="trigger-lesson-content" href="#" data-template="[pb_html_hint][/pb_input]" data-type="content-block">Text Input + hint and feed back</a>
                */}
                </div>
              </div>
              </div>
           ...
           <div class="box-inset col-md-3">
                <h1 style={{marginTop:"100px",fontSize:"15px"}}>Video</h1>
              <div class="wrapper-box">
                <input  type="checkbox" />
                <div class="fab"></div>
                <div class="fac">
                  <a class="trigger-lesson-content" href="#" data-title="html" data-template="[pb_html][/pb_video]" data-type="content-block" ><i class="fa fa-link"></i>Add video component</a>
                  <a class="trigger-lesson-content" href="#" data-title="iframe" data-template="[pb_html][/pb_live]" data-type="content-block"><i class="fa fa-link"></i>Add meetings component</a>
                  <a class="trigger-lesson-content" href="#" data-template="[pb_html][/pb_broadcasting]" data-type="content-block">Add broadcasting component</a>
                </div>
              </div>
              </div>
           ...
           <div class="box-inset col-md-3">
              ...
              <div class="wrapper-box">
                ...
                <div class="fab "></div>
                <div class="fac">
                  <a class="trigger-lesson-content" href="#" data-title="html" data-template="[pb_link][/pb_html]" data-type="content-block" ><i class="fa fa-link"></i>HTML</a>
                  <a class="trigger-lesson-content" href="#" data-title="iframe" data-template="[pb_iframe][/pb_iframe]" data-type="content-block"><i class="fa fa-link"></i> IFRAME</a>
                  <a class="trigger-lesson-content" href="#" data-template="[pb_video][/pb_video]" data-type="content-block">ANOTHER</a>
                </div>
              </div>
              </div>
...
const addSectionContent = () => {
  ...
  <tr    data-id="${'miller_'+ mycounter }" id="dynamic_section_${mycounter}" onclick="showSubsection(this)" class="view ${'miller_'+ mycounter } section-list" style="min-width:100%;width:100%;height:60px;border-left:3px solid black;margin-top:10px;">
  ...
  const template = `
      ...
      <td colspan="7">
        <div class="fold-content">
          <h3 style="font-size:15px">Subsections</h3><br/>
