          ...
          <div class="builder-content">
            ...
            <div id="template-container">
              ...
              <div class="pb-widget-preview">
                <span class="row-btn btn-widget pb-handle-widget fa fa-sort">
                  handle
                </span>
                <div></div>
                <span
          ...
          <div class="modal-build-inner">
            ...
            <div class="modal-tabs">
              <div class="modal-tab widgets-tab active-tab">
                <i class="tab-icon fas fa-hammer"></i>Textual Content
              </div>
              <div class="modal-tab background-tab">
                <i class="tab-icon fas fa-fill"></i> Media
              </div>
              <div class="modal-tab special-tab">
                <i class="tab-icon fas fa-star"></i> Specials
              </div>
            </div>
            <div class="modal-build-content widgets-tab active-content">
              <div
                class="pb-widget"
                data-template="[pb_text][/pb_text]"
              ...
              <div
                class="pb-widget"
                data-template="[pb_button][/pb_button]"
                data-type="content-block"
              >
              ...
              <div
                class="pb-widget"
                data-template="[pb_slider][/pb_slider]"
                data-type="content-block"
              >
                <div>
              ...
              <div
                class="pb-widget"
                data-template="[pb_image][/pb_image]"
                data-type="content-block"
              >
            ...
            <div class="modal-build-content background-tab">
              <div
                class="pb-widget"
                data-template="[pb_color_section][/pb_color_section]"
              ...
              <div
                class="pb-widget"
                data-template="[pb_background_video][/pb_background_video]"
                data-type="background"
              >
              ...
              <div
                class="pb-widget"
                data-template="[pb_fullscreen_background][/pb_fullscreen_background]"
                data-type="background"
              >
            ...
            <div class="modal-build-content special-tab">
              <div
                class="pb-widget"
                data-template="[pb_masonry][/pb_masonry]"
                data-type="special"
              >
