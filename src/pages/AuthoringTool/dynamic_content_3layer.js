  ...
  PlaceholderTemplate = () => {
   ...
   let Content = this.pbCreateNode('div', null , 'Add Sub Section');
    ...
    LessonWrapper.style.color="#fff"
     ...
     let LessonWrapperContent = this.pbCreateNode('div', null , 'Add Lesson to Section');
...
let that = this;
    ...
    this.SubBlock = document.querySelector("#template-container > .pb-row-subblock");
    ...
    document.querySelector(".builder").addEventListener("click", (e) => this.handleClonedEvents(e));
...
handleClonedEvents = (e) => {
   if ( e.target.getAttribute("id") =="pb-modal-close" && e.target.matches('.closeit') && !e.target.matches(".pb-widget") && !e.target.hasAttribute("data-template")) {
      this.closeModal(e)
   }else if(e.target.matches('.fa-trash')){
     removeBlock(e)
   }else if(e.target.matches(".pb-widget") && e.target.hasAttribute("data-template") && e.target.hasAttribute("data-type")){
...
<br/><br/><br/>
      ...
      <div class="builder-content">
       {/*    ACTION BUTTONS */}
        <div class="pb-actions">
          <a class="pb-add-row builder-btn"   href="#myModalDynamicCreation" role="button" data-toggle="modal">Add Section</a>
        </div>
          ...
          <div class="pb-row" name="pb-row" style={{border:"1px solid #000"}}>
            ...
            <div class="pb-container">
              <div class="builder-row-content">
                   ...
                   <div class="pb-row-subblock pb-rows-sub" name="pb-row-subblock">
            ...
            <div class="pb-container">
              <div class="builder-row-content">
                   ...
                   <div class="pb-row-subblock" name="pb-row-subblock">
                      ...
                      <div class="pb-container">
                        <div class="builder-row-content-subsection">
                  ...
                  <span class="panel-title" style={{float:"left",color:"#000",marginLeft:"10px"}}>Headings</span>
                            <div class="actions" style={{float:"right"}}> 
                             <i class="pb-handle-widget fa fa-sort" ></i>
                               ...
                               <i class="pb-remove fa fa-trash"  onClick={this.handleWidgetRemove}></i>
  ...
  {/*Add edit modal for sections/sub sections/ lessons dynamic content */}
   ...
   <div style={{marginTop:"80px"}} class="modal fade" id="myModalDynamicCreation" tabindex="-1" role="dialog" aria-hidden="true">
