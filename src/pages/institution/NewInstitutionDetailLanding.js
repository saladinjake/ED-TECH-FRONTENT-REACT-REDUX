...
class DynamicContentForInstitutions extends Component {
   ...
   getInstitution(){
    return Datas.institutions.find(institution => parseInt(institution.id) === parseInt(this.id))
   }
            ...
            <div>
              <NavBar />
                ...
                <div className="heroMan">
                  <h1><span>Offered By</span> <br/>{currentInstitution?.institution}</h1>
                  <h4> </h4>

                  <div className="heroContentLeft">
                     <span>By Programs . {currentInstitution?.institution} . Explore</span>
                     <h2  style={{color:"#fff", marginTop:"10px"}}>{currentInstitution?.fullname}</h2>
                     <p style={{color:"#fff", fontSize:"20px", marginTop:"10px",width:"500px"}}>{currentInstitution?.intro}</p>
                    ...
                    <div>
                           <div style={{
                             ...
                             <img style={{borderRadius:"50%", width:"50px",marginRight:"20px",
                                    height:"50px"}} src={`${currentInstitution?.hero_image}`}   />
                                <span>{currentInstitution?.institution} Career Certifaction</span>
                                </div>
                    ...
                    <div>
                           <div style={{
                             ...
                             <button style={{ width:"200px",marginRight:"20px",height:"100px", background:"darkblue"}} className="btn btn-primary"    >Enroll For Course</button>
                   ...
                   <div id="sidebar-top-view">Sidebar top</div>
                    <div id="main-view">
                            ...
                            <div className="tabby">
                                ...
                                <input type="radio" name="tab" id="tabby3" onClick={() => {this.redressFooter()}}/>
                                ...
                                <div className="tabby-content-wrapper">
                                  <div id="tabby-content-1" className="tabby-content">
                                    ...
                                    <Container  lg="12"  style={{border:"1px solid #f6f6f6"}}>
                                        <Row >
                                          ...
                                          <Col lg="12" style={{padding:"3px",color:"#000", fontSize:"20px", marginLeft:"20px"}}>
                                                     <p style={{color:"#000", fontSize:"20px"}}>What you will learn
                                                     </p>
                                          </Col>

                                          {currentInstitution?.outcomes?.map((outcome)=>{
                                              return (
                                                   <Col lg="6" style={{padding:"10px",color:"#000", fontSize:"20px"}}>
                                                     <p style={{padding:"10px",color:"#000", fontSize:"20px"}}>{outcome}
                                                     </p>
                                                 </Col>
                                          ...
                                          <Col lg="12" style={{padding:"3px",color:"#000", fontSize:"20px", marginLeft:"20px"}}>
                                                     <p style={{color:"#000", fontSize:"20px"}}>Skills you would achieve
                                                     </p>
                                          </Col>
                                          ...
                                          {
                                            currentInstitution?.skills_acquired?.map(skillPills =>{
                                                return (
                                                  <Col lg="3" style={{padding:"10px",color:"#fff", borderRadius:"20px", height:"50px", fontSize:"10px", margin:"15px",background:"#f4f4f4", marginLeft:"30px"}}>
                                    ...
                                    <h3 style={{margin:"10px"}}>About This Certifaction</h3>
                                     ...
                                     <Container  lg="12"  >
                                        <Row>
                                          ...
                                          <Col lg="12" style={{padding:"20px",color:"#000", fontSize:"20px"}}>
                                  ...
                                  <div id="tabby-content-3" className="tabby-content">
                                    ...
                                    <h4>There are {currentInstitution?.courses?.length} courses in this certification </h4>
                                            ...
                                            {data?.body.map( (data,index) =>{
                                                ...
                                                return (
                                                   ...
                                                   <Col md="3" style={{marginLeft:"20px"}}>
                                                       <h6> Sub Courses </h6>
                                                       <h4 style={{fontSize:"25px",width:"50px"}}> {index + 1}</h4>
                                                   </Col>
                                                   <Col md="9" key={i} style={{marginLeft:"100px"}}>
                                                        <Link to={"#"}>
                                                            <div className="">
                                                                
                                                                <div className="box-title profile-description" id="profile-description">
                                                                    <h6 style={{fontSize:"24px"}}>{data?.title}</h6>
                                                                  
                                                                  <div className="text show-more-height">
                                                                    <p style={{fontSize:"14px", color:"#000"}}>{data?.info}</p>
                           ...
                           <div style={{
                            ...
                            <i className="fa fa-graduation-cap fa-2x" style={{borderRadius:"50%", marginRight:"20px",float:"left"}}    />
                         ...
                         <div style={{
                            ...
                            <i className="fa fa-globe fa-2x" style={{borderRadius:"50%", marginRight:"20px"}}    />
                          ...
                          <div style={{
                            ...
                            <i className="fa fa-signal fa-2x" style={{borderRadius:"50%", marginRight:"20px"}}    />
                          ...
                          <div style={{
                            ...
                            <i className="fa fa-graduation-cap fa-2x" style={{borderRadius:"50%", marginRight:"20px"}}    />
                                 <span style={{fontSize:"25px"}}>Approximately 6 months to complete</span>
                           </div>
