  ...
  return (
    <div className="container-fluid" style={{background:"#fafafa"}}>
      <div className="vc_row wpb_row row vc_row-fluid vc_custom_1533037364435 vc_row-o-equal-height vc_row-flex">
        <div className="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-6 vc_col-md-6 col-md-6 ">
        ...
        module__e162146b69965b286e7c69b138e79c08"
                >
                  <img
                   ...
                   src={process.env.PUBLIC_URL+ "/assets/images/downloadword.jpg"} width="100%"
                    height="231"
                    alt="image_box_1"
                    title="image_box_1"
                  />
                  ...
                  <div className="center">
                    ...
                    <div className="stm_image_box__textarea"  style={{fontSize:"16px", fontFamily:"Open Sans", color:"#000"}}>
                      <b>Using our courses as it is or customized, or using our
                      ...
                      most wanted job-relevant subject areas.</b>
                    </div>
                    <br />
                    <a
                      href="#"
              ...
              <div className="left ">
                <div className=" stm_image_box stm_image_box__style_1 module__6b24da982b01ea58104f2ed8a956b2fb">
                  ...
                  <div className="center">
                    ...
                    <div className="stm_image_box__textarea"  style={{fontSize:"16px", fontFamily:"Open Sans", color:"#000"}}>
                      <b>In addition to the need to provide adequate training and
                      ...
                      training needs using our world-class platform.</b>
                    </div>
                    <br />
                    <a
                      href=""
