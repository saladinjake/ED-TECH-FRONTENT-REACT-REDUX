...
const InstructorNavBar = ({
  ...
  return (
    <Fragment>
      <nav
        className="desktop"
        style={{ position: "fixed", zIndex: "9999999999999999999999999999" }}
      >
        ...
        >
          <li className="NavHover">
            ...
            >
                          ...
                          >
                            ...
                            {item.subcategories.length > 0 &&
                              item.subcategories.map((cat, i) => {
                                // if(i%2 ===0){
                                leftSide += `<a style="background:#fff,font-size: 12px, font-family:'Montserrat'" href="#" >${cat.name}</a>
                                                              `;
                                // }else if(i%2 !==0){
              ...
              >
                <span style={{ fontSize: "12px", fontFamily: "Open Sans" }}>
                  By Learning Style
                </span>
                <ul
                  className="NavSubMenu makeText"
