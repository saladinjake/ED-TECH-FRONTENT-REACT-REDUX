  ...
  return (
    <section className="cta mainCta">
      <div className="cta__item brown">
        <figure className="cta__item-icon mt-xs">
          <img src={professor} alt="professor" />
        </figure>
        <h3 className="badge mt-xs">For Businesses</h3>
        <p className="info mt-xs">
          Using our courses as it is or customized, or using our platform for
          your own internal courses, our aim is to help you create essential
          skills pathways with verifiable and stackable credentials to upskill
      ...
      <div className="cta__item inst">
        ...
        <p className="info mt-xs">
          In addition to the need to provide adequate training and education for
          their staff, some government agencies also have the responsibilities
          to provide training and skill acquisition services to the public. We
