...
const TestForm = ({}) => {
  ...
  window.drf = {
    ...
    csrfToken:
      "BflbcAqq5u5i8NdzTKBhUZmfFrYXlb1tZwq3EQPrUornyky8l9Vn2AKUJkfHXVR6",
  };
                  ...
                  >
                    <fieldset>
                      <input
                        ...
                        value="BflbcAqq5u5i8NdzTKBhUZmfFrYXlb1tZwq3EQPrUornyky8l9Vn2AKUJkfHXVR6"
                      />
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-sm-10">
                          <input
                            ...
                            class="form-control"
                            type="text"
                            value="Tested from Authoring end"
                          />
                        </div>
                      </div>
                      ...
                      <div class="form-group horizontal-checkbox ">
                        <label class="col-sm-2 control-label ">Auditing</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <select class="form-control" name="institution">
                            <option value="cb85e4ff-6636-4201-8e9f-5a9259c936bf">
                              UniLag
                            </option>

                            <option value="78b31745-7233-4857-ac5e-6a1c5080691a">
                              Uniben
                            </option>

                            <option value="041eef28-9c99-4e7b-8652-e000c13a84d1">
                              Harvard
                            </option>
                          </select>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          >
                            ...
                            <option value="30007f4a-0826-4416-ab5e-3b6d236876ad">
                              juwavictor@gmail.com
                            </option>

                            <option value="529c54d4-dacd-45ce-8f11-aae7e68fcdc3">
                              Tarun.Khanna@gmail.com
                            </option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <select
                            ...
                            class="form-control"
                            name="prerequisite"
                            value="6a8c0445-8581-4f19-93a2-84fd3b7e1399"
                          >
                            <option
                              value="6a8c0445-8581-4f19-93a2-84fd3b7e1399"
                              selected
                            ...
                            <option value="d971e036-2846-4f6a-99e1-0fe9b64073ce">
                              edx-course
                            </option>

                            <option value="a6149f65-fb7b-4b1d-b43e-1384d486e9c3">
                              course1
                            </option>

                            <option value="fd3a6e73-e95b-4199-990b-553f15218276">
                              Entrepreneurship in Emerging Economies
                            </option>

                            <option value="b2d94259-bcb7-4b66-83f3-e3cca787e29d">
                              Data Science
                            </option>

                            <option value="a67d2e42-3580-461c-a6e8-40449da8ce10">
                              testing
                            </option>

                            <option value="1a7fe6cd-1e40-4fc3-b71c-562bc80b8114">
                              testing
                            </option>
                          </select>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <select
                            ...
                            name="authoring_team"
                          >
                            <option value="097cd2bb-ae72-48e4-9a4d-1ebd2c05be03">
                              Johnsmith@lect.com
                            </option>
                      ...
                      <div class="form-actions">
                        <button
                          ...
                          title="Make a POST request on the Course Create resource"
                        >
                          POST
                        </button>
                      </div>
