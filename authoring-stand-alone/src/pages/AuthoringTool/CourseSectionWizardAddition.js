          ...
          <div class="pb-widget-preview">
            <div style={{ background: "#ebebeb" }}>
              <div class="panel-heading">
                <span
                  class="panel-title"
                  style={{ float: "left", color: "#000", marginLeft: "10px" }}
                >
                  Headings
                </span>
              ...
              <div class="modal-build-content widgets-tab active-content container-fluid">
                <div class="box-inset col-md-3">
                  ...
                  <div class="wrapper-box">
                    ...
                    <div class="fac">
                      <a
                        class="trigger-lesson-content"
                        href="#"
                        data-title="html"
                        data-template="[pb_link][/pb_html]"
                        data-type="content-block"
                      >
                        <i class="fa fa-link"></i>Add HTML Component
                      </a>
                      <a
                        class="trigger-lesson-content"
                        href="#"
                        ...
                        data-type="content-block"
                      >
                        <i class="fa fa-link"></i>Add IFRAME Component
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="box-inset col-md-3">
                  <h1 style={{ marginTop: "100px", fontSize: "15px" }}>
                    Problems
                  </h1>
                  <div class="wrapper-box">
                    <input type="checkbox" />
                    ...
                    <div class="fac">
                      <a
                        ...
                        href="#"
                        data-title="html"
                        data-template="[pb_html][/pb_html]"
                        data-type="content-block"
                      >
                        <i class="fa fa-link"></i>Add Common Problems
                      </a>
                      <a
                        class="trigger-lesson-content"
                        href="#"
                        data-title="iframe"
                        data-template="[pb_html][/pb_chkbox]"
                        data-type="content-block"
                      >
                        <i class="fa fa-link"></i>Add Checkboxes
                      </a>
                      <a
                        class="trigger-lesson-content"
                        href="#"
                      ...
                      <a
                        ...
                        href="#"
                        data-title="html"
                        data-template="[pb_html][/pb_multichoice]"
                        data-type="content-block"
                      >
                        <i class="fa fa-link"></i>Add Multiple Choice
                      </a>
                      <a
                        class="trigger-lesson-content"
                        href="#"
                        data-title="iframe"
                        data-template="[pb_html][/pb_numeric]"
                        data-type="content-block"
                      >
                        <i class="fa fa-link"></i>Add Numerical Input
                      </a>
                      <a
                        class="trigger-lesson-content"
                        href="#"
                        data-template="[pb_html][/pb_input]"
                        data-type="content-block"
                      >
                        Text Input
                      </a>
                  ...
                  <div class="wrapper-box">
                    ...
                    <div class="fac">
                      <a
                        ...
                        href="#"
                        data-title="html"
                        data-template="[pb_html][/pb_video]"
                        data-type="content-block"
                      >
                        <i class="fa fa-link"></i>Add video component
                      </a>
                      <a
                        class="trigger-lesson-content"
                        href="#"
                        data-title="iframe"
                        data-template="[pb_html][/pb_live]"
                        data-type="content-block"
                      >
                        <i class="fa fa-link"></i>Add meetings component
                      </a>
                      <a
                        class="trigger-lesson-content"
                        href="#"
...
const addSectionContent = () => {
  ...
  <tr    data-id="${
    "miller_" + mycounter
  }" id="dynamic_section_${mycounter}" onclick="showSubsection(this)" class="view ${
    "miller_" + mycounter
  } section-list" style="min-width:100%;width:100%;height:60px;border-left:3px solid black;margin-top:10px;">
...
const addSubSectionContent = (el) => {
  ...
  const template = `
         ...
         <tr  id="dynamic_subsection_${muu_counter}"  data-id="${
    "muu_" + muu_counter
  }" class="fold ${"muu_" + muu_counter} section-parent_${localStorage.getItem(
    "tracker"
  )} subsection-child_${localStorage.getItem(
    "s_tracker"
  )} " style="min-width:100%;width:100%;height:60px;border-left:3px solid black;margin-top:10px">
      <td colspan="7">
